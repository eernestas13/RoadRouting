...
describe('urlTools', function () {
    it("should parse URL correctly", function () {
        var params = urlTools.parseUrl("localhost:8080?test=pest&test2=true&test3=false&test4=2&test5=1.1&test5=2.7");
    ...
    it("should create object from dotted URL parameter", function () {
        ...
        var params = urlTools.parseUrl("localhost:8080?pt.test=now&pt.go.test=single&pt.go.further=far&pt.go.further=now");
        ...
        // params = urlTools.parseUrl("localhost:8080?pt.mix=now&pt.mix.test=now2");
